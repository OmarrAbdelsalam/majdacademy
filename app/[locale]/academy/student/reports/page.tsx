...
import type { Report } from '@/lib/academy/types';
...
export default function StudentReportsPage() {
  ...
  useEffect(() => {
    async function loadReports() {
      try {
        const data = await services.reports.getReports({ studentId: user.id });
    ...
    <div dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">
          {isRTL ? 'تقاريرك الدراسية من المعلمين' : 'Your academic reports from teachers'}
        </p>
      </div>
