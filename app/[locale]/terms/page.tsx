  ...
  const content = {
    ar: {
      ...
      sections: [
        ...
        { title: "الخدمات التعليمية", text: `نقدم خدمات تعليمية أونلاين تشمل حصص فردية وجماعية وفقاً للمنهج المعتمد في ${countryAr}. نحتفظ بالحق في تعديل أو إيقاف أي خدمة مع إشعار مسبق. جميع المواد التعليمية محمية بحقوق الملكية الفكرية ولا يجوز نسخها أو توزيعها.` },
    ...
    en: {
      ...
      sections: [
        ...
        { title: "Educational Services", text: `We provide online educational services including individual and group sessions following the ${countryEn} curriculum. We reserve the right to modify or discontinue any service with prior notice. All educational materials are protected by intellectual property rights.` },
