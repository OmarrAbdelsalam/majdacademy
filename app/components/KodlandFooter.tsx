      ...
      <div className="relative z-10 px-4 sm:px-6">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm max-w-[1300px] mx-auto">
          ...
          <div className="flex items-center justify-between mb-10">
            <img src="/majd.png" alt="مَجْد" className="h-10 w-auto" />
            <a
              href="#packages"
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3">
                {content.footer.col1Links.map((link, i) => (
                  <li key={i}><a href="#" className="text-[15px] font-medium text-[#262626] hover:text-[#ef5da8] transition-colors">{link}</a></li>
                ))}
              </ul>
            </div>
          ...
          <div className="flex items-center gap-3 mb-8">
            {/* WhatsApp */}
            <a href="https://wa.me/971000000000" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#262626] flex items-center justify-center hover:bg-[#ef5da8] transition-colors">
            ...
            {/* Instagram */}
            <a href="#" className="w-9 h-9 rounded-full bg-[#262626] flex items-center justify-center hover:bg-[#ef5da8] transition-colors">
          ...
          <div className="border-t border-gray-100 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-[13px] font-medium hover:text-[#ef5da8] transition-colors" style={{ color: "rgba(38,38,38,0.5)" }}>{content.footer.privacy}</a>
              <a href="#" className="text-[13px] font-medium hover:text-[#ef5da8] transition-colors" style={{ color: "rgba(38,38,38,0.5)" }}>{content.footer.terms}</a>
            </div>
          </div>
