    ...
    <>
      <section className="relative w-full min-h-[70vh] flex flex-col items-center justify-center overflow-hidden pt-[60px] pb-16">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto px-4 sm:px-6 text-center mt-16 sm:mt-24">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="mx-auto mt-6" style={{ fontSize: "clamp(15px, 3.5vw, 20px)", fontWeight: 500, lineHeight: "1.7", maxWidth: "700px", color: "rgba(38,38,38,0.7)" }}>
            {c.subtitle}
          </motion.p>

          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.25 }} className="mt-4" style={{ fontSize: "14px", fontWeight: 600, color: "#ef5da8" }}>
            {c.grades}
          </motion.p>
