      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6">
          <div className="relative">
            ...
            <div className="rounded-[32px] overflow-hidden relative bg-cover bg-center" style={{ backgroundImage: "url('https://cdn.kodland.org/main-site-v2/bg-pink.png')" }}>
              <div className="relative z-10 px-6 py-12 md:px-16 md:py-20">
                <div className="text-center mb-12">
                  <h2 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 800, letterSpacing: "-0.02em", lineHeight: "120%", color: "#fff" }}>
