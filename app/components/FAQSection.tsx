            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center gap-4 px-2 py-6 md:py-7 text-right group"
                >
                  {/* Number */}
                  <span
                ...
                >
                  <div className="pr-12 pb-6">
                    <p
                      ...
                      style={{ fontSize: "16px", fontWeight: 500, color: "rgba(38,38,38,0.6)" }}
                    >
                      {item.answer}
                    </p>
                  </div>
