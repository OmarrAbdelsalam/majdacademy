...
export default function KodlandHero() {
  ...
  return (
    <section className={`relative w-full ${variant === "fusha" ? "min-h-[85svh]" : "min-h-[100svh]"} flex flex-col items-center justify-center lg:justify-start overflow-hidden pt-[80px] lg:pt-[60px] pb-16`}>
      ...
      {variant === "fusha" && (
        <div
          className="absolute inset-0 z-[1]"
          style={{
            backgroundImage: "linear-gradient(to bottom, rgba(255,255,255,0.7) 0%, rgba(255,255,255,0) 25%), url('https://cdn.kodland.org/main-site-v2/bg-ellipse.webp')",
            backgroundSize: "cover, cover",
            backgroundPosition: "top, center -10vh",
            backgroundRepeat: "no-repeat",
          }}
        />
      )}
      ...
      {/* ═══ Main Content — Center ═══ */}
      <div className={`relative z-20 max-w-[90vw] mx-auto px-2 sm:px-6 text-center ${variant === "fusha" ? "mt-6" : "mt-12"} lg:mt-32 flex flex-col items-center justify-center`}>
        {/* Main Heading */}
        <motion.h1
        ...
        >
          ...
          <br />
          {isRTL ? (
            <span className="block mt-4 px-2 w-full overflow-visible">
              <span className="relative inline-block whitespace-nowrap" style={{ fontSize: "clamp(34px, 9vw, 90px)", letterSpacing: "0.04em", lineHeight: "1.4" }}>
                <span
                  ...
                  style={{
                    ...
                    top: variant === "fusha" ? "-6px" : "-4px",
                    bottom: variant === "fusha" ? "-6px" : "-4px",
                    left: "-12px",
                    right: "-12px",
            ...
            <span className="block mt-2 px-2 w-full overflow-visible">
        ...
        <motion.p
          ...
          className={`mx-auto px-2 mt-0 ${variant === "fusha" ? "sm:mt-4 lg:mt-6" : "sm:mt-8 lg:mt-10"}`}
          style={{
            fontSize: variant === "fusha" ? "clamp(16px, 4vw, 20px)" : "clamp(15px, 3.5vw, 20px)",
            fontWeight: 500,
            letterSpacing: "-0.01em",
            lineHeight: variant === "fusha" ? "1.8" : "1.7",
            marginBottom: "0",
            maxWidth: "700px",
            color: variant === "fusha" ? "rgba(38,38,38,0.8)" : "#262626",
            textAlign: "center",
          }}
        >
        ...
        <motion.div
          ...
          className={`mt-4 ${variant === "fusha" ? "sm:mt-6" : "sm:mt-10"}`}
        >
          <button
            ...
            style={{
              padding: variant === "fusha" ? "clamp(14px, 2.5vw, 24px) clamp(24px, 4vw, 44px)" : "clamp(16px, 3vw, 24px) clamp(28px, 5vw, 44px)",
        ...
        <motion.div
          ...
          className={`mt-6 ${variant === "fusha" ? "sm:mt-12" : "sm:mt-20"} flex items-center justify-center gap-5 sm:gap-8`}
        >
          <Image
