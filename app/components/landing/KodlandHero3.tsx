...
export default function KodlandHero3({ locale }: { locale: string }) {
  ...
  const t = {
    ...
    desc1: isRTL ? "دروس تفاعلية حية تؤسس طفلك في القراءة والنحو " : "Live interactive lessons establishing reading and grammar ",
    descHighlight: isRTL ? "بثقة، " : "with confidence, ",
    desc2: isRTL ? "بأسلوب ممتع يواكب المنهج المعتمد في " : "in an engaging way aligned with the curriculum in ",
    desc3: isRTL ? "، مع برامج خاصة لغير الناطقين بها." : ", plus special programs for non-native speakers.",
